...
parser.add_argument("--root", type=Path, default=Path.cwd(), help="作品输出根目录；本地指定项目根目录")
...
template = package / "references/模板_作品项目启动包.md"
renderer = package / "scripts/render_delivery_html.py"
try:
