...
The documentation, workflow descriptions, creative rules, visual creation methods, rubrics, prompts, templates, and Markdown knowledge assets are licensed under Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International.
...
- `04_诊断与系统日志/**/*.md`
- `skills/**/SKILL.md`
- AI 视觉创作规则、剧本开发方法、资产设计规则、分镜规则、视频提示词规范、质量评估规则、复盘协议等方法论内容
...
Commercial use of the documentation, creative methods, rules, prompts, rubrics, templates, knowledge assets, project workflow, course-like content, and personal brand assets is not allowed without permission, because those materials are released under CC BY-NC-SA 4.0 or reserved brand rights.
