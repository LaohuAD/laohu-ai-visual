...
现在你只要给它一个题材、一个画面、一段故事，或者一首歌的最终音频、歌词和创作背景，它会先由总导演把真实目的变成观众经历和全片取舍，再交给编导型编剧、MV 导演、美术、人物、声音、资产、视频提示词、封面和复盘等专业节点。生产按状态前进，节点之间可以会商和返工；前面确定的人物、关系、音色、歌曲时间证据和视觉规则会继续传到后面，不用每换一个模型就重新交代一遍。
