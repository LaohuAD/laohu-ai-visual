...
require_pattern "skills/laohu_generation_review/SKILL.md" "视觉落点.*导引线.*块面压掉杂质" "generation review checks point-line-plane composition"
...
require_pattern "02_共享资产库/05_工具流程/助手执行失败经验与防复发规则.md" "点线面必须先解决视觉落点|不能让观众第一眼无处可看" "failure rules record point-line-plane composition lesson"
