...
|---|---|---|---|---|---|
| 灵感沟通 |  | 待开始 | 待确认 | 确定故事内容 |  |
| 故事内容确认 | \`01_世界观故事/文本/00_故事确认.md\` | 待开始 | 待确认 | 剧本结果输出文件 | 故事确认稿放世界观故事目录，不放剧本目录 |
| 剧本结果输出文件 |  | 待开始 | 待确认 | 资产图片提示词输出文件 |  |
| 资产图片提示词输出文件 |  | 待开始 | 待确认 | 分镜表格输出文件 |  |
| 分镜表格输出文件 |  | 待开始 | 待确认 | 第一个分镜视频提示词展示文件 |  |
| 第一个分镜视频提示词展示文件 |  | 待开始 | 待确认 | 所有分镜视频提示词结果输出文件 |  |
| 所有分镜视频提示词结果输出文件 |  | 待开始 | 待确认 | 老胡制作完成后生成封面 |  |
| 封面生成 |  | 待开始 | 待确认 | 归档 |  |
